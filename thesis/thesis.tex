...
\begin{itemize}
    ...
    \item \textbf{EVO-HEURISTIC} - Genetic algorithm implementation where the individual represents only clustering and routing is done heuristically
...
\include{thesis/A01userguide}
\include{thesis/A02developerdocs}
