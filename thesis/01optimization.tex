...
\todo{General description of the meta-heuristic}

\subsection{Individual as routes of stops}

\todo{Reformat, reformulate paragraphs below}
...
\todo{Describe the approach in a similar manner as above (after the text above us updated)}

\subsection{Individual as only clustering with heuristic routing}

\todo{Describe the approach in a similar manner as above}
